...
if st.button("Generate Pro Script"):
    if movie_name:
        # ဒီနေရာမှာ Error မတက်အောင် အရိုးရှင်းဆုံး နာမည်ကို သုံးထားပါတယ်
        ...
        with st.spinner('Script ရေးနေပါသည်... ခဏစောင့်ပေးပါ...'):
            try:
                # ဖြေရှင်းချက်- API Version နှင့် မငြိအောင် model.generate_content တိုက်ရိုက်သုံးသည်
                ...
                # Error ထပ်တက်ရင် ဘာကြောင့်လဲဆိုတာ တိတိကျကျ သိရအောင် ပြပေးထားပါသည်
